...
exports.amountTimeGetGraphData = void 0;
const amountTimeGetGraphData = async (filterOps, knex) => {
    const { timeFilter, table, filterBy, timeChoiceField, sumChoiceField, dataFilter } = filterOps;
    ...
    switch (filterBy) {
        ...
        case "month":
            ...
            dateValues.push(`${yearDefault}-${monyrDefault}-01`, monyrDefault, yearDefault);
            break;
        case "last30days":
...
exports.amountTimeGetGraphData = amountTimeGetGraphData;
